...
extern(C++) interface IDCompositionDevice : IUnknown
{
	...
	HRESULT CreateTransform3DGroup(
		IDCompositionTranslationTransform3D* transform3D,
		UINT elements,
...
extern(C++) interface IDCompositionRotateTransform : IDCompositionTransform
{
	...
	HRESULT SetCenterY(float centerY);
    /// Animates the value of the CenterY property.
	HRESULT SetCenterY(IDCompositonAnimation animation);
}
...
extern(C++) interface IDCompositionMatrixTransform : IDCompositionTransform
{
	...
	HRESULT SetMatrixElement(int row, int column, IDCompositioAnimation animation);
}
...
mixin(uuid!(IDCompositionScaleTransfrom3D, "2A9E9EAD-364B-4b15-A7C4-A1997F78B389"));
...
extern(C++) interface IDCompositionScaleTransform3D : IDCompositionTransform3D
{
	...
	HRESULT SetScaleY(float scaleY);
    /// Animates the value of the ScaleY property.
	HRESULT SetScaleY(IDCompositioAnimation animation);
